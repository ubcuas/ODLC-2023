...
class DroneInfo:
    def __init__(
        ...
        Args:
            x: x-coord of drone on GPS in meters, inches, feet etc.
            y: y_coord on GPS in the same unit as x
            theta: direction of drone WRT the positive x-axis of GPS in degrees
            h: height of the drone in the same unit as x
            FOV_x: field of view of the drone in the x direction
        """
